-- OrgConc -- Correcao de tipos UUID em ambientes com schema legado (INTEGER PKs)
-- Executa no Supabase: SQL Editor -> New Query -> Cole e rode
-- IDEMPOTENTE: verifica o tipo atual antes de alterar.

-- Garante extensao necessaria para gen_random_uuid() em ambientes legados
...
BEGIN
  ...
  -- Remove tabelas dependentes em ordem correta (filhas antes das maes)
